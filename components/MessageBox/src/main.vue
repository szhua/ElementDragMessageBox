<template>
  <transition name="msgbox-fade">
    ...
    >
      <div class="el-message-box" :style="{position:'relative'}" :class="[customClass, center && 'el-message-box--center']">
...
import elDragBox from '@/directive/el-drag-box' // base on element-ui
